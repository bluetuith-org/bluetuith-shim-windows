...
internal static class Output
{
    ...
    internal static void ReplyToAuthenticationRequest(long operationId, string response)
    {
...
internal abstract class OutputBase
{
    ...
    internal virtual void SetAuthenticationResponse(long operationId, string response) { }
